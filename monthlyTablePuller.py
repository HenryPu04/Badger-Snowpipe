...
#Uncomment below if you want to extract 7-days data
puller = BadgerTablePuller(date(last_week_start.year, last_week_start.month, last_week_start.day), 7, DAY)
#Uncomment below if you want to extract monthly data
#puller = BadgerTablePuller(date(start_month.year, start_month.month, start_month.day), 1, MONTH)

#Uncomment below if you only want to extract data for the period you specified
puller.run()
#Uncomment below if you want to extract data for the period you specified and the next period
#puller.run_parallel()